...
import 'package:wallscape/model/categoryModel.dart';
import 'dart:math';
...
class ApiOperations{
  ...
  static String _apiKey =
      "QwnG76w5zRWD5aEmef4bGlOIq0G4MwvMmQ2iXONKFMiI9UZo0LyuiUtz";
  ...
  static Future<List<PhotosModel>> searchWallpapers(String query) async{
    await http.get(
        ...
        headers: {"Authorization": "QwnG76w5zRWD5aEmef4bGlOIq0G4MwvMmQ2iXONKFMiI9UZo0LyuiUtz"}
    ).then((Value) {
      Map<String , dynamic> jsonData = jsonDecode(Value.body);
      List photos = jsonData["photos"];
